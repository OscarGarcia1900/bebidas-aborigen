...
export function ShareButtons({ productName, productDescription, productUrl }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 mt-4">
      ...
      <button
        ...
        className="p-2 rounded-full bg-[#25D366] text-white hover:bg-[#20BA5A] transition-colors"
      ...
      <button
        ...
        className="p-2 rounded-full bg-[#1877F2] text-white hover:bg-[#145dbf] transition-colors"
